...
import 'package:simp_app/UtilsTools.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:simp_app/EventsClass.dart';
import '../EventProviderClass.dart';
...
class _EventEditingPageState extends State<EventEditingPage> {
  ...
  Widget buildTitle() => TextFormField(
        ...
        decoration: InputDecoration(
            border: UnderlineInputBorder(), hintText: "New Event Title"),
  ...
  Widget buildDateTimePicker() => Column(children: [buildFrom(), buildTo()]);
